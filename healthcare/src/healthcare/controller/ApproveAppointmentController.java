 ...
 */
@WebServlet("/ApproveAppointmentController")
public class ApproveAppointmentController extends HttpServlet {
     ...
     */
    public ApproveAppointmentController() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(s!=null)
			for(String strID: s.split(" ")){
				String sql="update appointments set status='active' where aid='"+strID+"';";
				stmt.execute(sql);
			...
			content = "Hello "+pname+"!<br>Your Appointment Request has been approved by the Hospital.<br><br>Your appointment details is as follows:<br><table border='0'><tr><td>Appointment ID:</td><td>"+aid+"</td></tr>"
					+ "<tr><td>Hospital Name:</td><td>"+hname+"</td></tr><tr><td>Doctor Name:</td><td>"+dname+"</td></tr><tr><td>Date:</td><td>"+date+"</td></tr><tr><td>Session:</td><td>"+session+"</td></tr><tr><td>From Time:</td><td>"+fromTime+"</td></tr><tr><td>To Time:</td><td>"+toTime+"</td></tr></table>";						
